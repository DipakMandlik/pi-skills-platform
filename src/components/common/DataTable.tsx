        ...
        <div className="mb-3">
          <div className="relative max-w-xs">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg text-sm text-[var(--color-text-main)] placeholder:text-[var(--color-text-light)] focus:outline-none focus:border-[var(--color-primary)] focus:bg-[var(--color-surface-elevated)] focus:ring-2 focus:ring-[var(--color-primary)]/10 transition-all duration-150"
            />
          </div>
        </div>
      )}
