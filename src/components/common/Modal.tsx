      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-y-auto p-3 sm:p-4">
          ...
          <motion.div
            ...
            className={clsx(
              'relative w-full max-h-[calc(100vh-1.5rem)] sm:max-h-[calc(100vh-2rem)] bg-[var(--color-surface-elevated)] rounded-xl shadow-2xl border border-[var(--color-border)] flex flex-col overflow-hidden',
              {
                'max-w-sm': size === 'sm',
                'max-w-md': size === 'md',
                'max-w-lg': size === 'lg',
          ...
          >
            ...
            {/* Footer */}
            {footer && (
              <div className="flex items-center justify-end gap-2 px-4 sm:px-5 py-3.5 sm:py-4 border-t border-[var(--color-border)] bg-[var(--color-surface)]/50">
                {footer}
              </div>
            )}
          </motion.div>
